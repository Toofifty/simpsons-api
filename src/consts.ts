export const CLIP_FILE_TYPES = ['mp4', 'gif', 'webm'] as const;
...
export const FILE_TYPES = [...CLIP_FILE_TYPES, ...SNAP_FILE_TYPES] as const;
...
export const MAX_CLIP_DURATION = 120_000; // ms
